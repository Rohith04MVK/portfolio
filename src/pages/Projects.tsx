...
const Projects = () => {
  return (
    <div className="bg-indigo-900 relative overflow-hidden h-screen">
      <img
        src="https://wallpapercave.com/wp/wp7563482.jpg"
        className="absolute h-full w-full object-cover"
      />
      <div className="grid lg:grid-cols-3">
        <Card
          title="Brain Tumor Detection Using UNET"
          src="https://prod-images-static.radiopaedia.org/images/17420182/258f5e41fb90d89f73d24c077e93f5_big_gallery.jpeg"
        >
          Hello Noobs
        </Card>
        <Card
